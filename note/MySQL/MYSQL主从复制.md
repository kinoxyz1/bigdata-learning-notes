...
![image-20220329231136992](../../img/mysql/mysql主从复制/image-20220329231136992.png)
...
![image-20220329231214389](../../img/mysql/mysql主从复制/image-20220329231214389.png)
...
![image-20220329231300735](../../img/mysql/mysql主从复制/image-20220329231300735.png)
...
![image-20220329231429347](../../img/mysql/mysql主从复制/image-20220329231429347.png)
...
![image-20220329231549800](../../img/mysql/mysql主从复制/image-20220329231549800.png)
...
![image-20220329232741694](../../img/mysql/mysql主从复制/image-20220329232741694.png)
...
![image-20220329232934516](../../img/mysql/mysql主从复制/image-20220329232934516.png)

![image-20220329232941780](../../img/mysql/mysql主从复制/image-20220329232941780.png)
...
![image-20220329232952153](../../img/mysql/mysql主从复制/image-20220329232952153.png)

如果报错：

![image-20220329232958011](../../img/mysql/mysql主从复制/image-20220329232958011.png)
...
![image-20220329233124775](../../img/mysql/mysql主从复制/image-20220329233124775.png)
...
![image-20220329233204316](../../img/mysql/mysql主从复制/image-20220329233204316.png)
...
- 如何重新配置主从
  ...
  ![image-20220329233352720](../../img/mysql/mysql主从复制/image-20220329233352720.png)
...
![image-20220329233433439](../../img/mysql/mysql主从复制/image-20220329233433439.png)



![image-20220329233448778](../../img/mysql/mysql主从复制/image-20220329233448778.png)
...
![image-20220329233714671](../../img/mysql/mysql主从复制/image-20220329233714671.png)
...
![image-20220329233747296](../../img/mysql/mysql主从复制/image-20220329233747296.png)
...
![image-20220329233800680](../../img/mysql/mysql主从复制/image-20220329233800680.png)
...
![image-20220329233847020](../../img/mysql/mysql主从复制/image-20220329233847020.png)
...
- 采用中间件的方法有很明显的优势，功能强大，使用简单。但因为在客户端和数据库之间增加了中间件层会有一些性能损耗，同时商业中间件也是有使用成本的。我们也可以考虑采取一些优秀的开源工具。
  ...
  ![image-20220329234028528](../../img/mysql/mysql主从复制/image-20220329234028528.png)
...
![image-20220329234200370](../../img/mysql/mysql主从复制/image-20220329234200370.png)

![image-20220329234212660](../../img/mysql/mysql主从复制/image-20220329234212660.png)

主备切换：

![image-20220329234237134](../../img/mysql/mysql主从复制/image-20220329234237134.png)
